    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('locations.index')" :active="request()->routeIs('locations.index')" wire:navigate>
                        {{ __('Locations') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('stocks.index')" :active="request()->routeIs('stocks.index')" wire:navigate>
                        {{ __('Stocks') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('pos.index')" :active="request()->routeIs('pos.index')" wire:navigate>
                        {{ __('POS') }}
                    </x-nav-link>
                </div>
            </div>
