    ...
    <div class="col-span-8">
        <form wire:submit.prevent="store" >
            <div class="grid grid-cols-12 bg-white gap-x-6 gap-y-8">
                ...
                <div class="col-span-4">
                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="cost">
                        Cost (EGP)
                    </label>

                    <div class="flex flex-row items-center w-full space-x-5">
                        <input wire:model="cost" id="cost" placeholder="Cost in Egyptian Pounds" class="block w-full px-4 py-2 text-sm text-gray-900 border border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    </div>
                </div>
                ...
                <div class="col-span-4">
                    ...
                    <div class="mt-2">
                        <input wire:model="barcode" type="text" id="barcode" placeholder="Enter Barcode" class="block w-full px-4 py-2 text-sm text-gray-900 border border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    @error('barcode')
                        <span class="text-sm text-red-500">{{ $message }}</span>
                    @enderror
